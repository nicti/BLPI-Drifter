...
var Find = /** @class */ (function (_super) {
    ...
    Find.prototype.registerCommand = function () {
        return new builders_1.SlashCommandBuilder()
            .setName('find')
            .setDescription('Finds all WHs of a certain type')
            .addStringOption(function (option) {
            return option.setName('wh')
                .setDescription('WH identifier')
                .setRequired(true)
                .addChoices({ name: 'B', value: 'B' }, { name: 'C', value: 'C' }, { name: 'V', value: 'V' }, { name: 'S', value: 'S' }, { name: 'R', value: 'R' });
        });
    };
    ...
    Find.prototype.executeInteraction = function (interaction) {
        return __awaiter(this, void 0, void 0, function () {
            var find, results, stableReturns, unstableReturns, dateObj, i, result, i, result, resultMessage;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        find = interaction.options.getString('wh').toUpperCase();
                        if (!!JoveStorage_1.default.WHS.includes(find)) return [3 /*break*/, 2];
                        return [4 /*yield*/, interaction.reply({ content: 'Insert correct wh type please: B,C,V,S,R', ephemeral: true })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                    case 2: return [4 /*yield*/, this.jove.resetOutdated()];
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, interaction.reply({ content: resultMessage, ephemeral: true })];
                    case 5:
                        _a.sent();
                        _a.label = 6;

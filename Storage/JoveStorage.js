...
var JoveStorage = /** @class */ (function () {
    ...
    JoveStorage.prototype.addSystem = function (region, system, id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        region = region.replace(/ /g, '_');
                        return [4 /*yield*/, this.db.push('region/' + region + '/' + system, {
                                updated: '',
                                whs: [],
                                id: id
                            })];
    ...
    JoveStorage.prototype.removeSystem = function (region, system) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        region = region.replace(/ /g, '_');
                        return [4 /*yield*/, this.db.delete('region/' + region + '/' + system)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
